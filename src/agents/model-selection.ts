...
// Lazy-initialized to avoid TDZ errors in bundled output when circular
// module dependencies cause this file to be evaluated before all top-level
// declarations have been assigned (see #45057).
